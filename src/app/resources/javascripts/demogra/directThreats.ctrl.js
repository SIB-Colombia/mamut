...
.controller('DirectThreatsCtrl', ['$scope','$http','ReferenceFactory', 'AncillaryDataFactory', function($scope,$http,ReferenceFactory,AncillaryDataFactory) {
	...
	$scope.addDirectThreats = function(){
		var req_1 = {
			method: 'POST',
			url: 'http://192.168.205.191:8080/fichas/'+$scope.formData._id+'/direct_threats/',
			headers: {
			  'Content-Type': 'application/JSON'
			},
			data: { "id_user" : "01",
				"directThreats":$scope.formData.directThreats
